  ...
  return (
    <div className='flex items-center justify-center min-h-screen  bg-gradient-to-br from-green-300 to-green-100 relative'>
      ...
      <form onSubmit={onSubmitHandler} className='bg-green-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
        ...
        <p className='text-center mb-6 text-green-300'>Enter the OTP sent to your email</p>
        ...
        <button type="submit" className='w-full py-3 bg-gradient-to-r from-green-300 to-green-700 text-white rounded-full cursor-pointer'>Verify email</button>
      </form>
    </div>
  )
}
