...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center m-20 px-40 text-center text-gray-800'>
      <img src={assets.header_img} alt="" className='w-36 h-36 rounded-full mb-6'/>
      <h1 className='flex items-center gap-2 text-xl sm:text-3xl font-medium mb-2'>Hey {userData ? userData.name : 'Dev'} !</h1>
